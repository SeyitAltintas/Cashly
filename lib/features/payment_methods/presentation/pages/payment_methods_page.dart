        ...
        children: [
          ...
          if (totalDebt > 0) ...[
            ...
            Container(
              padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(
                color: ColorConstants.koyuKirmizi.withValues(alpha: 0.2),
              ...
              child: Row(
                children: [
                  Icon(
                    Icons.credit_score,
                    color: ColorConstants.koyuKirmizi.withValues(alpha: 0.8),
                    size: 20,
                  ),
                  const SizedBox(width: 8),
                  Text(
                    "Toplam Kredi Kartı Borcu: ${totalDebt.toStringAsFixed(2)} ₺",
                    style: TextStyle(
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 8),
                Text(
                  "Toplam ${_filtrelenmisYontemler.length} adet ödeme yöntemi",
                  style: TextStyle(
                    color: Colors.white.withValues(alpha: 0.9),
                    fontSize: 13,
                  ),
