  ...
  void _clearLogs() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Tüm yerel hata kayıtları silinecek. Emin misiniz?'),
        actions: [
          TextButton(
                        ...
                        children: [
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                const Text('Detaylar', style: TextStyle(fontWeight: FontWeight.bold)),
                                const SizedBox(height: 8),
                                SelectableText('Error: ${log['error']}'),
                                const SizedBox(height: 8),
                                if (log['stackTrace'] != null && log['stackTrace']!.isNotEmpty && log['stackTrace'] != 'Belirtilmedi') ...[
