...
# Remove media methods and voice methods in one go!
# They are between _pickAndReturnVideoPath and // ─── Build
media_and_voice_pattern = r'  Future<String\?> _pickAndReturnVideoPath\(BuildContext context\) async \{.*?  // ─── Build ─+'
content = re.sub(media_and_voice_pattern, '  // ─── Build ──────────────────────────────────────────────────────────────', content, flags=re.DOTALL)
