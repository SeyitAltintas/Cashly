...
content = content.replace('_pickAndReturnImagePathFromCamera(', 'NoteMediaHelper.pickImage(fromCamera: true, ')
content = content.replace('_pickAndReturnVideoPathFromCamera(', 'NoteMediaHelper.pickVideo(fromCamera: true, ')
...
content = content.replace("import 'package:path_provider/path_provider.dart';\n", "")
content = content.replace("import 'package:image_picker/image_picker.dart';\n", "")
content = content.replace("import 'package:cashly/core/services/image_compression_service.dart';\n", "")
